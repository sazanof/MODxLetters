...
$lang['template_code_info'] = 'В коде шаблона необходимо использовать <b>{{ content|raw }}</b> переменную для вывода тела самого письма.<br>Для вствки ссылки чтобы отписаться от рассылки, используйте <b>{{ unsuscriber_link|raw }}</b><br> Не забывайте об этом!';
...
$lang['unsuscribe_success'] = 'Вы успешно отписались от рассылки';
